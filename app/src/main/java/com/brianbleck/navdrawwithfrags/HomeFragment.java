...
public class HomeFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    TextView homeText = view.findViewById(R.id.home_text);//until it is inflated, we can't findviewbyid
    homeText.setText(text);
    return view; //until this is returned, this is not part of the activity
  }
